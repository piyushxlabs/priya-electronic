...
export const metadata: Metadata = {
    title: "About Us | Priya Electronic - Home Appliances in GhāziābĀd",
    description: "Learn about Priya Electronic - your trusted local electronics shop in GhāziābĀd since 2010.",
};
